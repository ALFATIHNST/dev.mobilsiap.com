  ...
  return (
    <>
      ...
      <main className="pt-24 min-h-screen" style={{ background: 'rgba(8,8,14,1)' }}>
        {/* Page Header */}
        <div className="py-16 px-4 sm:px-6 lg:px-8" style={{ background: 'rgba(10,10,16,0.9)', borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-white/50 text-lg mt-4 max-w-xl">
              Punya pertanyaan tentang mobil atau layanan kami? Hubungi tim MobilSiap melalui berbagai saluran komunikasi di bawah ini.
            </p>
          </div>
        </div>
        <ContactInfo />
        <div className="py-16 px-4 sm:px-6 lg:px-8" style={{ background: 'rgba(10,10,16,0.95)' }}>
