        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-8 reveal-up">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <Link href="/cars-for-sale" className="btn-primary py-3.5 px-7 text-sm">
                <Icon name="TruckIcon" size={16} className="text-white" />
                Lihat Mobil
              </Link>
              <Link href="/consignment" className="flex items-center gap-2 py-3.5 px-7 rounded-full text-white text-sm font-700 hover:bg-white/10 transition-all" style={{ fontWeight: 700, border: '1px solid rgba(255,255,255,0.15)' }}>
                Titip Jual
